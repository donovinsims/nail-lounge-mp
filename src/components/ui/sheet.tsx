...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-3 transition data-[state=closed]:duration-[240ms] data-[state=open]:duration-[240ms] data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
