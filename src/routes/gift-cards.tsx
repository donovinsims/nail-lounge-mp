...
const OCCASIONS = [
  {
    ...
    body: "A private 2-hour window for the bride and her party — matching sets, mimosas welcome.",
  },
  {
    title: "Birthdays",
    body: "Reserve a corner of the studio for 4–8 guests. Group polish change or full mani-pedi.",
  },
  {
    title: "Mother–daughter day",
    body: "Two seats side-by-side. Bring a book; we'll bring the tea.",
  },
  {
    title: "Corporate & client gifts",
    body: "Bulk gift cards with a custom note, hand-delivered or emailed.",
  },
];
      ...
      <section className="border-b border-border/60">
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 sm:py-28">
          ...
          <p className="mt-6 max-w-xl text-base text-muted-foreground">
            Give an hour of quiet, careful work — or reserve the studio for a small group. We host
            parties of 4 or more by appointment.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 sm:py-28">
          ...
          <div className="mt-12 rounded-3xl bg-card p-8 sm:p-10">
            ...
            <ol className="mt-6 space-y-3 text-sm text-muted-foreground">
              <li>
                <span className="font-mono text-foreground">01</span> &nbsp; Call or email with your
                date, group size, and what you have in mind.
              </li>
              <li>
                <span className="font-mono text-foreground">02</span> &nbsp; We'll hold the studio,
              ...
              <li>
                ...
                — bring snacks, music, or champagne.
              </li>
            </ol>
            <div className="mt-8 flex flex-wrap gap-3">
              <a
